...
Функция СведенияОВнешнейОбработке() Экспорт 
	...
	Если ЕстьОбщийМодуль("ДополнительныеОтчетыИОбработки") Тогда
		...
		ПараметрыРегистрации.Версия = "0.0.3";
...
Функция Bitrix_Пользователь(ВебХук, ИДПользователя) Экспорт
...
Функция Bitrix_Задача_ПолучитьЗатраченноеВремя(ВебХук, НомерЗадачи, ИДПользователя, ТолькоДанныеПоТекущемуПользователю = Ложь) Экспорт
